                        ...
                        {categories.map((category) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`shrink-0 rounded-full px-4 py-2.5 text-sm font-medium transition-all duration-200 ${active
                                ...
                                >
                                    ...
                                    <div className="p-4">
                                        ...
                                        <div className="mt-5 flex items-center justify-between border-t border-[#E5E7EB] pt-4 dark:border-[#2A3A2D]">
                                            <div
                                                className={`flex items-center gap-1.5 text-xs font-semibold ${priceIncreased
