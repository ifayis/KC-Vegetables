      ...
      ========================================================== */}
          ...
          ====================================================== */}
                    <div className="max-w-3xl">
                        ...
                        >
                            From local farms to your table — discover the
                            latest vegetable market prices and quality fresh
                            produce at a fair value.
                        </motion.p>
                            ...
                            <div className="w-56 rounded-2xl border border-white/50 bg-white/90 p-3.5 text-[#1F2937] shadow-[0_20px_60px_rgba(0,0,0,0.22)] backdrop-blur-xl">
                                <AnimatePresence mode="wait">
                                    ...
                                    >
                                        ...
                                        <div className="mt-3 flex items-center justify-between border-t border-gray-200 pt-3">
                                            ...
                                            <div
                                                className={`flex items-center gap-1.5 text-xs font-semibold ${vegetable.trend === 'up'
                                                    ? 'text-[#2E7D32]'
                                                    : 'text-[#D97706]'
                                                    }`}
                                            >
                                ...
                                <div className="mt-3 flex items-center gap-1">
                                    {featuredVegetables.map((item, index) => (
                                        <span
                                            key={item.name}
                                            className={`h-1 rounded-full transition-all duration-500 ${index === activeVegetable
                                                ? 'w-5 bg-[#2E7D32]'
                                                : 'w-1.5 bg-gray-300'
                                                }`}
                                        />
